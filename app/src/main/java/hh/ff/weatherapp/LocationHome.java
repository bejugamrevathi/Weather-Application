...
public class LocationHome extends Activity {
	TextView tv;
...
sp=(Spinner)findViewById(R.id.spinner1);
	        ...
	        b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
				    ...
				    String str = "http://api.openweathermap.org/data/2.5/weather?q="+sp.getSelectedItem().toString()+"&appid=7c59fc7ce3a9920fe681da32a7859d2f";
		...
		class MyLoaderTask extends AsyncTask<String, String, String> {
			...
			protected void onPostExecute(String file_url) {
				...
				tv.setText(name+country+setrise+guess+desc+mint+maxt+pressure+sealevel+grndlevel);
